...
Thanks for your interest in contributing. This project bridges [HaloPSA](https://halopsa.com/) to the [Model Context Protocol](https://modelcontextprotocol.io/) so AI agents can query and manage PSA data safely.
...
| `schema/` | Offline reporting DB catalog for LLM schema tools |
